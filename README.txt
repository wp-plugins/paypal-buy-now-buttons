...
Easy to use WordPress plugin to accept paypal payment for a service/ product/ donation in one click.
...
`[paypal_buy_now_buttons]`
`[paypal_buy_now_buttons item_name="abc" amount="50"]`
